    ...
    return(
        <div className=" min-h-screen flex items-center justify-center p-12 bg-gradient-to-br from-indigo-900 via-violet-800 to-purple-700">
            <div  className="w-full max-w-md bg-white p-6 rounded-xl shadow">
                <h2 className="text-2xl font-bold text-centre mb-4 hover:text-violet-800">Login</h2>
                ...
                <input type="password" placeholder="password" className="w-full border p-2 rounded mb-3 focus:outline-none focus:ring-2 focus:ring-blue-500"></input>
